...
_FIELD_LABELS = {
    ...
    "client_type": "client",
    "content_id": "content",
    "content_error_code": "content_error",
...
FIELD_SPECS: dict[str, Callable[[object], object]] = {
    ...
    **{name: _validate_positive for name in _SLOT_FIELDS},
    ...
    "underlying_error_code": _validate_token,
