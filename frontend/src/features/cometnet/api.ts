...
export function getCometNetPool(poolId: string): Promise<CometNetPoolDetailData> {
  return apiRequest<CometNetPoolDetailData>(
    `/api/v1/admin/cometnet/pools/${encodeURIComponent(poolId)}`,
    { scope: "admin" },
  );
}
...
export function joinCometNetPool(input: PoolJoinInput): Promise<CometNetMutationData> {
  return apiRequest<CometNetMutationData>(
    `/api/v1/admin/cometnet/pools/${encodeURIComponent(input.poolId)}/join`,
    {
...
export function createCometNetInvite(poolId: string): Promise<CometNetInviteData> {
  return apiRequest<CometNetInviteData>(
    `/api/v1/admin/cometnet/pools/${encodeURIComponent(poolId)}/invites`,
    {
...
export function revokeCometNetInvite(input: {
  ...
  return apiRequest<CometNetMutationData>(
    `/api/v1/admin/cometnet/pools/${encodeURIComponent(input.poolId)}/invites/${encodeURIComponent(input.inviteCode)}`,
    { method: "DELETE", scope: "admin" },
  );
}
...
export function setCometNetSubscription(input: {
  ...
  return apiRequest<CometNetMutationData>(
    `/api/v1/admin/cometnet/pools/${encodeURIComponent(input.poolId)}/subscription`,
...
export function addCometNetMember(input: {
  ...
  return apiRequest<CometNetMutationData>(
    `/api/v1/admin/cometnet/pools/${encodeURIComponent(input.poolId)}/members`,
    {
...
export function removeCometNetMember(input: {
  ...
  return apiRequest<CometNetMutationData>(
    `/api/v1/admin/cometnet/pools/${encodeURIComponent(input.poolId)}/members/${encodeURIComponent(input.memberKey)}`,
    { method: "DELETE", scope: "admin" },
  );
}
...
export function leaveCometNetPool(poolId: string): Promise<CometNetMutationData> {
  return apiRequest<CometNetMutationData>(
    `/api/v1/admin/cometnet/pools/${encodeURIComponent(poolId)}/leave`,
